/* Parser.java
* Parses input csv file from USDA plants database and converts it to JSON format for use with
* Firebase database.
*
 */
import java.io.File;
    ...
    *
    ...
    public void parseInputFile() throws IOException {
        ...
        while (currPlant != null) {
            ...
            String species = fields[SPECIES_NAME_INDEX];
    ...
    *
    ...
    public void writeToOutputFile() throws IOException {
        ...
        for (String s : plantMap.keySet()) {
            ...
            writeLine(THREE_TABS + "\"common name\": \"" + plantMap.get(s)[COMMON_NAME_INDEX] + "\",");
            ...
            if (plantMap.get(s)[SOIL_PH_MIN_INDEX].equals("0") || plantMap.get(s)[SOIL_PH_MAX_INDEX].equals("0") ||  
                plantMap.get(s)[SOIL_PH_MIN_INDEX].equals("NA") || 
                plantMap.get(s)[SOIL_PH_MAX_INDEX].equals("NA")) {
